    ...
    <div class="row justify-content-center">
        <div class="col-md-8 restaurant-box text-center">
            ...
            <ul class="text-start d-inline-block">
                <li><i class="bi bi-credit-card me-2 text-success"></i>Registrar pagos</li>
                <li><i class="bi bi-receipt me-2 text-primary"></i>Emitir comprobantes</li>
                <li><i class="bi bi-clock-history me-2 text-warning"></i>Historial de cobros</li>
            </ul>
