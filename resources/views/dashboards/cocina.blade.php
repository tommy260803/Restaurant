...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-md-8 restaurant-box text-center">
            ...
            <h2 class="title-restaurant">Panel Cocina</h2>
            <p class="subtitle mb-4">Área de Cocina - Restaurante</p>

            <p class="fs-5 mb-3 welcome-text">
                ¡Hola, <strong>{{ $usuario->nombre_usuario }}</strong>!  
                Bienvenido al panel de cocina.
            </p>

            <p class="info-text">
                Desde aquí puedes revisar los pedidos asignados a cocina y actualizar su estado.
            </p>

            <ul class="text-start d-inline-block">
                <li><i class="bi bi-list-task me-2 text-danger"></i>Ver pedidos pendientes</li>
                <li><i class="bi bi-fire me-2 text-warning"></i>Marcar en preparación</li>
                <li><i class="bi bi-check2 me-2 text-success"></i>Marcar preparados</li>
            </ul>
